...
// 발표자 클래스
class Presenter: NSObject, ObservableObject {
    // 전송하고자하는 정보?
...
extension Presenter: MCNearbyServiceAdvertiserDelegate {
    // Advertise Not Begin
...
extension Presenter: MCNearbyServiceBrowserDelegate {
    // Browsing Not Begin
...
extension Presenter: MCSessionDelegate {
